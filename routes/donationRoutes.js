...
router.post("/banners/update", updateBannerImage);
...
router.get("/donors/list", getAllDonations);
router.get("/donations/80g", getAll80GDonations);
router.delete("/donors/:id", deleteDonation);
// Route to update PAN and address for a donation
router.put(
  "/tax/update/:donationId/pan-address",
  authenticateUser,
  updateDonationDetails
);
router.get(
  "/donations/receipt/:transaction_id",
  authenticateUser,
  downloadDonationReceipt
);
